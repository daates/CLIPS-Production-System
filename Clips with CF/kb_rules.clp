; =====================================================
; kb_rules.clp - Правила вывода (auto-generated)
...
(defrule r1
 ...
 =>
   (bind ?premise-cf (min ?c0 ?c1))
   (bind ?new-cf (* ?premise-cf 0.9))
   (update-known f31 ?new-cf)
